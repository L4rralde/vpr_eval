...
DATASET_ROOT = '/media/emmanuel/hdd_storage/pittsburgh/'
GT_ROOT = '/home/emmanuel/Desktop/crocodl_challenge/experiments/dino/gsv-cities/datasets/' # BECAREFUL, this is the ground truth that comes with GSV-Cities
